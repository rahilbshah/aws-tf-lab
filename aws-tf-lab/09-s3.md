...
| 9.2 | [[09-s3-advanced]] | replication (CRR/SRR), multipart upload, Transfer Acceleration, byte-range fetch, S3 Select, event notifications, Glacier retrieval tiers, Storage Lens | *pending* |
| 9.3 | [[09-s3-security]] | bucket policies vs IAM vs ACLs, Block Public Access, encryption (SSE-S3/KMS/C, client-side), presigned URLs, Object Lock, MFA delete, access points | *pending* |
